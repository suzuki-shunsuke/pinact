...
func TestController_getLatestVersionFromReleases(t *testing.T) { //nolint:funlen
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotVersion, err := c.getLatestVersionFromReleases(ctx, logger, "owner/repo", "owner", "repo", tt.isStable, time.Time{})
...
func TestController_getLatestVersionFromTags(t *testing.T) { //nolint:funlen
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			gotVersion, err := c.getLatestVersionFromTags(ctx, logger, "owner/repo", "owner", "repo", false, time.Time{})
